    ...
    public function run()
    {
        DB::table('attractions')->insert([
            ...
            [
                ...
                ',
                'city_id' => '3',
                'address' => 'Village, Jatiluwih Kawan Street No.Desa, Jatiluwih, Penebel, Kabupaten Tabanan, Bali 82152',
                'latitude' => '-8.370055',
            ...
            [
                ...
                'description' => 'Grand Dutch colonial administration building dating to the 1920s, now West Java\'s government house.',
                'city_id' => '10',
                'address' => 'Diponogoro Street no. 22, Bandung 40115 Indonesia',
                'latitude' => '-6.901736',
                'longitude' => '107.618724',
                'phone' => '+62 813 2003 7595',
                'category_id' => '3',
                'popular' => true,
                'created_at' => now(),
                'updated_at' => now(),
            ...
            [
                'name' => 'Botanical Garden Flowers',
                'description' => 'A botanical garden is a garden dedicated to the collection, cultivation, preservation and display of a wide range of plants labelled with their botanical names.',
                'city_id' => '11',
                'address' => 'Ir H Juanda Street no. 13, Bogor 16122 Indonesia',
                'latitude' => '-6.597224',
                'longitude' => '106.799441',
                'phone' => '+62 251 8322 187',
                'category_id' => '9',
                'popular' => true,
                'created_at' => now(),
                'updated_at' => now(),
            ...
            [
                'name' => 'Mekarsari Fruit Garden',
                'description' => 'Mekarsari Fruit Garden is a recreational area that offers agro-tourism concept. In its early beginning, Mekarsari Fruit Garden was built to be a plant conservation center. Over time, Taman Buah Mekarsari is also functioned as a center of education, reforestation, and recreation.',
                'city_id' => '11',
                'address' => 'Cileungsi-Jonggol Highway, KM.3, Cileungsi, Bogor.',
                'latitude' => '-6.597224',
                'longitude' => '106.799441',
                'phone' => '+62 218 231 822',
                'category_id' => '6',
                'popular' => true,
                'created_at' => now(),
                'updated_at' => now(),
            ...
            [
                'name' => 'Indonesia Safari Park',
                'description' => 'Taman Safari Indonesia (TSI) is a world-class zoo and titled the best conservation site by Indonesian Ministry of Forestry.',
                'city_id' => '11',
                'address' => 'Cileungsi-Jonggol Highway, KM.3, Cileungsi, Bogor, 16820 Indonesia',
                'latitude' => '-6.707606',
                'longitude' => '106.947744',
                'phone' => '021-7208880',
                'category_id' => '7',
                'popular' => true,
                'created_at' => now(),
            ...
            [
                'name' => 'Cibeureum Waterfall',
                'description' => 'Cibeureu Waterfall is the largest and shortest waterfall in this area, it is located more open and near the shelter so that it is more crowded. The name Cibeureum comes from the Sundanese language which means red river, this name is taken from the red nuances of the cliff walls which are formed from the red moss that grows endemically there.',
                'city_id' => '11',
                'address' => 'Cisarua Puncak Street KM. 10, Bogor Indonesia',
                'latitude' => '-6.754188',
                'longitude' => '106.986116',
                'phone' => '021-7208880',
                'category_id' => '2',
                'popular' => false,
                'created_at' => now(),
